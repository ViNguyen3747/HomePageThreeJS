...
gradientTexture.magFilter = THREE.NearestFilter; //without this, webgl will merge all 3 shade of 3.jpg
...
for (let i = 0; i < particlesCount; i++) {
  ...
  positions[i * 3 + 1] =
    objectDistance * 0.5 -
    Math.random() * objectDistance * sectionMeshes.length; //for sectionMeshes.length, more meshes, further particles down
